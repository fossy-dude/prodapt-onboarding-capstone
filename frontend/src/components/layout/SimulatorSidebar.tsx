...
import { Activity, Bell, Cpu, LogOut } from "lucide-react";
...
const SIMULATOR_NAV: readonly NavItem[] = [
  { label: "CDR Simulator", to: "/simulator/cdr", icon: Activity },
  { label: "Notifications", to: "/simulator/notifications", icon: Bell },
  { label: "SIM Activation", to: "/simulator/sim-activation", icon: Cpu },
];
