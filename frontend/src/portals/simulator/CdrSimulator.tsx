...
export function CdrSimulator() {
  ...
  const traceEvents =
    lastTraceId !== null
      ? events.filter((e) => e.trace_id === lastTraceId)
      : [];
  ...
  function handleField<K extends keyof DispatchForm>(
    key: K,
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleField("subscriberMsisdn", e.target.value)
                }
            ...
            <div>
              ...
              <select
                ...
                value={form.cdrType}
                onChange={(e) =>
                  handleField("cdrType", e.target.value as CdrType)
                }
                className="w-full rounded border border-neutral-300 px-3 py-2 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
              >
            ...
            {form.cdrType === "voice" && (
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleField("durationSeconds", e.target.value)
                  }
                  className="w-full rounded border border-neutral-300 px-3 py-2 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
                />
              </div>
        ...
        <Card>
          ...
          {lastTraceId === null ? (
            <p className="text-sm text-neutral-400">
              Dispatch a CDR to see trace stages here.
            </p>
          ) : traceEvents.length === 0 ? (
            ...
            <div
              className="space-y-2"
              aria-label="Pipeline trace stages"
              aria-live="polite"
            >
