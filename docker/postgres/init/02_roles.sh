...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "$POSTGRES_DB" <<-EOSQL
    ...
    BEGIN
        ...
        ELSE
            ALTER USER sboai_app WITH PASSWORD '${POSTGRES_APP_PASSWORD}';
        END IF;
    END
    \$\$;
    ...
    BEGIN
        ...
        ELSE
            ALTER USER sboai_readonly WITH PASSWORD '${POSTGRES_READONLY_PASSWORD}';
        END IF;
    END
    \$\$;
    ...
    BEGIN
        ...
        ELSE
            ALTER USER sboai_flyway WITH PASSWORD '${POSTGRES_FLYWAY_PASSWORD}';
        END IF;
    END
    \$\$;
    ...
    BEGIN
        ...
        ELSE
            ALTER USER langfuse_app WITH PASSWORD '${LANGFUSE_DB_PASSWORD}';
        END IF;
    END
    \$\$;
