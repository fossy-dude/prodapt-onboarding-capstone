...
SUPPORT_SYSTEM_PROMPT = (
    ...
    "  with data_preference / voice_preference / sms_preference, each 'more', 'less', or omitted —"
    " set only the axes they actually stated a preference for.\n"
    "  If recommend_plan returns needs_clarification=true, ask the subscriber what they want more or less of"
    " (data, calling minutes, or SMS) then call recommend_plan again with that preference.\n"
