...
def test_new_produces_uuidv7_event_id() -> None:
    env = EventEnvelope.new(event_type="cdr.raw", payload={"x": 1}, trace_id="abc123")
...
def test_new_defaults_utc_timestamp() -> None:
    ...
    env = EventEnvelope.new(event_type="cdr.raw", payload={}, trace_id="t1")
...
def test_round_trip_json() -> None:
    env = EventEnvelope.new(event_type="cdr.raw", payload={"a": "b"}, trace_id="tid")
