...
- **Unpinned image tags on redpanda, localstack, otel-collector, otel-tui** — Breaking changes possible across `docker pull`; pin to specific digests for reproducibility when stabilising the stack
