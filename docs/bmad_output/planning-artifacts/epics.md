...
# 1. AI-Powered Prepaid Billing System - Epic Breakdown
...
### 1.3.1. Epic 1: Core Infrastructure, Tooling & Subscriber Identity
...
### 1.3.2. Epic 2: CDR Pipeline, Balance Engine, Synthetic Data & Simulator Tools
...
### 1.3.3. Epic 3: Subscriber Self-Care Portal
...
### 1.3.4. Epic 4: Notifications & USSD Interface
...
### 1.3.5. Epic 5: Self-Care Chatbot — Multi-Agent (TDD-first)
...
### 1.3.6. Epic 6: Fraud Detection (TDD-first)
...
### 1.3.7. Epic 7: Ops & Marketing Dashboard (TDD-first)
...
## 1.4. Epic 1: Core Infrastructure, Tooling & Subscriber Identity
...
### 1.4.1. Story 1.1: UX Brief — Subscriber Registration & Identity Flows
...
### 1.4.2. Story 1.2: Podman Compose Stack, Postgres Init & Flyway Baseline
...
### 1.4.3. Story 1.3: Project Tooling — Justfile, GitHub Actions CI, Linters & README
...
### 1.4.4. Story 1.4: Pydantic-settings Singleton, Health Endpoints & OTEL Trace Middleware
...
### 1.4.5. Story 1.5: LangFuse Self-Hosted Setup & Client Instrumentation Scaffold
...
### 1.4.6. Story 1.6: Subscriber Registration, TRAI CAF & PII Encryption
...
### 1.4.7. Story 1.7: SIM Activation Order Tracker UI
...
### 1.4.8. Story 1.8: Login, OTP Step-Up & JWT Role-Based Auth
...
### 1.4.9. Story 1.9: Profile Management & KYC Status View
...
### 1.4.10. Story 1.10: Saved Payment Methods & PCI-DSS Tokenisation
...
## 1.5. Epic 2: CDR Pipeline, Balance Engine, Synthetic Data & Simulator Tools
...
### 1.5.1. Story 2.1: Redpanda Topic Provisioning & Kafka Envelope Contract
...
### 1.5.2. Story 2.2: CDR Ingestion Consumer — Dedup & DLQ
...
### 1.5.3. Story 2.3: Balance Deduction Engine — Valkey Write Buffer & Postgres Flush
...
### 1.5.4. Story 2.4: Audit Log & Distributed Trace Propagation
...
### 1.5.5. Story 2.5: CDR Management API — DLQ Inspect & Worker Control
...
### 1.5.6. Story 2.6: Synthetic Dataset Generation — Plans, Subscribers & CDRs
...
### 1.5.7. Story 2.7: Milvus Lite Initialisation & Vector Seeding
...
### 1.5.8. Story 2.8: CDR Simulator UI — Form, Dispatch & WebSocket Trace Display
...
### 1.5.9. Story 2.9: SIM Activation Simulator & Notification Portal
...
## 1.6. Epic 3: Subscriber Self-Care Portal
...
### 1.6.1. Story 3.1: UX Brief — Balance, Usage & Recharge Portal Flows
...
### 1.6.2. Story 3.2: Real-Time Balance Display & Usage Breakdown
...
### 1.6.3. Story 3.3: Transaction History Ledger
...
### 1.6.4. Story 3.4: Plan Details View & Plan Catalogue
...
### 1.6.5. Story 3.5: Recharge Purchase — Plan Selection & Simulated Payment
...
### 1.6.6. Story 3.6: PDF Receipt Generation
...
## 1.7. Epic 4: Notifications & USSD Interface
...
### 1.7.1. Story 4.1: Notification Service — Low Balance, Depletion & Plan Expiry Alerts
...
### 1.7.2. Story 4.2: Notification Preferences & Delivery Simulation
...
### 1.7.3. Story 4.3: Rate Limiting — Per-Subscriber 100 RPM
...
### 1.7.4. Story 4.4: USSD Session Handler & Menu Router
...
## 1.8. Epic 5: Self-Care Chatbot — Multi-Agent (TDD-first)
...
### 1.8.1. Story 5.1: UX Brief — Chatbot Interface & AG-UI Stream Flows
...
### 1.8.2. Story 5.2: Eval Harness — LLM-as-Judge & DeepEval Scaffolding
...
### 1.8.3. Story 5.3: RAG Pipeline — Milvus Hybrid Search
...
### 1.8.4. Story 5.4: CopilotKit Runtime & Support Agent Graph
...
### 1.8.5. Story 5.5: Input Validation Guardrails
...
### 1.8.6. Story 5.6: Recharge via Chatbot & Multi-Agent Tool Calls
...
### 1.8.7. Story 5.7: Rating Agent — Charge Breakdown Explanation
...
### 1.8.8. Story 5.8: Dispute Workflow & Balance Management Agent
...
### 1.8.9. Story 5.9: Plan Recommendation Tool & Feedback Loop
...
### 1.8.10. Story 5.10: Conclusion Agent & Notification Agent (Session End)
...
## 1.9. Epic 6: Fraud Detection (TDD-first)
...
### 1.9.1. Story 6.1: Eval Harness — Fraud Detection Agent Accuracy
...
### 1.9.2. Story 6.2: Rule-Based CDR Pre-Screener
...
### 1.9.3. Story 6.3: Fraud Detection Agent — LLM-Powered Risk Analysis
...
### 1.9.4. Story 6.4: Real-Time Anomaly Feed & Fraud Case Queue UI
...
### 1.9.5. Story 6.5: SIM Swap & Suspicious Recharge Alerts
...
### 1.9.6. Story 6.6: Account Takeover Prevention — Blacklist, Cognito Disable & JWT Revocation
...
## 1.10. Epic 7: Ops & Marketing Dashboard (TDD-first)
...
### 1.10.1. Story 7.1: Eval Harness — ML Forecast & Upsell Quality
...
### 1.10.2. Story 7.2: Plan Stock Dashboard & Order Fulfilment View
...
### 1.10.3. Story 7.3: Subscriber Growth Forecast (ML, 3-Month)
...
### 1.10.4. Story 7.4: Plan Demand Forecast (30–90 Day)
...
### 1.10.5. Story 7.5: Target Base Builder — Dynamic KPI Filter
...
### 1.10.6. Story 7.6: LLM Segment Labelling & Rule Induction Agent
...
### 1.10.7. Story 7.7: Segment Classification at Scale & Upsell Strategy Agent
...
### 1.10.8. Story 7.8: Ops Observability Dashboard — CDR Monitor & Pipeline Health
...
### 1.10.9. Story 7.9: Root Cause Analysis Agent
